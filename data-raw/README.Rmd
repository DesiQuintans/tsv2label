...
The Appendix below has the [formal definition of a dictionary](#formal), but the easiest way to understand how a data dictionary is shaped is by looking at the one that is included with `tsv2label`. You can find where it is installed on your computer by running:
...
Converting to Factor always comes first in our [order of operations](#order).
